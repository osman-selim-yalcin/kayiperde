...
export default function Footer() {
  ...
  return (
    ...
    >
      ...
      <div
        className="
          container mx-auto px-5 sm:px-6 py-10
      ...
      >
        ...
        <div className="w-full max-w-sm space-y-4">
          <h4 className="text-lg sm:text-xl font-bold tracking-wide text-[#EDE5D9]">
            İletişim
          </h4>

          <div className="text-sm text-[#EDE5D9]/90">İbrahim Köseoğlu</div>
          <a
            href="tel:05446655150"
            className="inline-block text-sm text-[#EDE5D9]/90 underline underline-offset-4"
          >
            Ara: 0544 665 51 50
          </a>
          ...
          <div className="flex items-center justify-center md:justify-start gap-3 pt-1">
            <a
              ...
              className="p-2.5 rounded-full border hover:scale-105 transition"
              style={{ borderColor: "#CBB8A2" }}
            >
              <svg viewBox="0 0 24 24" width="18" height="18" fill="#EDE5D9">
        ...
        <div className="w-full max-w-sm">
          <h4 className="text-lg font-semibold text-[#EDE5D9] mb-2">
            Çalışma Saatleri
          </h4>
          <table className="w-full text-sm text-[#F4EFE8]/90">
            <tbody>
              {hours.map(([day, hour]) => (
                <tr
                  key={day}
                  className="grid grid-cols-2 py-1 justify-items-center md:justify-items-start"
                >
                  <td className="pr-4">{day}</td>
                  <td className="text-right md:text-left">{hour}</td>
                </tr>
              ))}
            </tbody>
          </table>
        ...
        {/* 3) Adres */}
        <div className="w-full max-w-sm">
          <h4 className="text-lg font-semibold text-[#EDE5D9] mb-2">Adres</h4>
          <address className="not-italic text-sm leading-relaxed text-[#F4EFE8]/90">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block mt-3 mx-auto md:mx-0 rounded-xl border px-3 py-2 text-xs md:text-sm transition hover:-translate-y-px"
            style={{ borderColor: "#CBB8A2" }}
          >
            Haritada Görüntüle
          </a>
      ...
      >
        <div className="max-w-6xl mx-auto px-5 sm:px-6 py-5 flex items-center justify-center text-[11px] md:text-xs">
